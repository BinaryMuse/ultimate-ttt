defmodule UltimateTtt.Game.InnerBoard do
  ...
  @opaque t :: %__MODULE__{data: {tile, tile, tile, tile, tile, tile, tile, tile, tile}}
  @type player :: :o | :x
  ...
  """
  @spec place_tile(t, space, player) :: {:ok, t} | {:err, :invalid_move}
  ...
  ## Examples
      ...
      iex> board = InnerBoard.new()
      iex> {:ok, board} = InnerBoard.place_tile(board, 0, :x)
      iex> {:ok, board} = InnerBoard.place_tile(board, 8, :o)
